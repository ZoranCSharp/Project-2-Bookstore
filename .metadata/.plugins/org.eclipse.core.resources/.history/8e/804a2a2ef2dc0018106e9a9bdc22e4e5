...
public class CheckoutController {
	...
	public String checkoutPost(@ModelAttribute("shippingAddress") ShippingAddress ahippingAddress,
		...
		LocalDate estimatedDelivaryDate;
		
		if(shippingMethod.equals("groundShipping")) {
			
			estimatedDelivaryDate = today.plusDays(5);
		}else {
			
			estimatedDelivaryDate = today.plusDays(3);
		}
		
		model.addAttribute("estimatedDelivaryDate", estimatedDelivaryDate);
